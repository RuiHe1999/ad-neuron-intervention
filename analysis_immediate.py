...
# 2. constants
task_name = "immediate_recall"
task_short = "immediate"
...
annot_1_path = "Chat_analysis/annotator_1/immediate.csv"
annot_2_path = "Chat_analysis/annotator_2/immediate.csv"
auto_path = "Chat_analysis/automated_analysis/immediate_recall_auto.xlsx"
...
for var in variables:
    ...
    # define family 
    if var in ["n_entities", "n_events", "n_tokens", "LexicalH", "perplexity", "mean_dep_dist"]:
