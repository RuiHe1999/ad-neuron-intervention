...
def extract_scene_scores(df, annotator):
    ...
    for lab in labels:
        ...
        counts[f"{annotator}_{lab}"] = counts[lab] / counts[f"{annotator}_total"]
...
auto_path = "Chat_analysis/automated_analysis/scene_ling.xlsx"
