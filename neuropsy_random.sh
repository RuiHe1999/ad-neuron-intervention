...
#SBATCH --array=0-49
#SBATCH --output=logs/npsy_random_%A_%a.out
#SBATCH --error=logs/npsy_random_%A_%a.err
...
python neuropsy_tests_random.py --model_type "$condition" --role "$role"
